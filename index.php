            ...
            <div class="row-fluid" id="content">
                <div class="span3 pull-right hidden-phone" id="rightCol">
                    <div data-spy="affix" data-offset-top="0">
                        <div class="thumbnail">
                            <img src="img/cats/200x200.jpg" data-src="holder.js/200x200" alt="ad 200x200" />
                        </div>
                    </div>
                </div>
                <div class="accordion span9 pull-left" id="secciones">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordionBtnA" data-toggle="collapse" data-parent="#secciones" href="#blogs">
                                <dl class="dl-horizontal">
                                    <dt>Blogs</dt>
                                    <dd class="muted">Tuerce los blogs recomendados ;)</dd>
                                </dl>                                
                            </a>
                        </div>
