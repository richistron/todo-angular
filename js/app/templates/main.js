...
(function() {
  ...
  (function(window) {
    ...
    App.Templates.modalBoxEntrie = "	<h1 class=\"entrieTitle\">{{title}}</h1>		<p><a href=\"{{link}}\">Ver original en sitio</a></p>	<p> {{&content}} </p>	<p> Publicado {{publishedDate}} </p>		<p>Author {{feedAuthor}}</p>	";
