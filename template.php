...
<html lang="es">
    ...
    <body>  
        ...
        <div id="container">
            <section id="sitios">
                <div class="box">
                    <article>
                        <header>                            
                            <h1>10 PHP code quality tools to avoid a mess in your projects</h1>
                        </header>                        
                        ...
                        <aside>
                            <a href="#" class="readmore">Leer más</a> <time datetime="2011-01-26" pubdate>Monday, January 26,2011</time> <span class="author"> Author: <strong> Fulanito </strong>                        
                        </aside>
                    </article>
                </div>
            </section>            
        ...
        <script src="js/libs-no-bootstrap.js"></script>
        <!--<script src="js/fancyRss.js"></script>-->
